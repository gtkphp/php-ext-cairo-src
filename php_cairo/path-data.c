...
php_cairo_path_data_t_class_init(zend_class_entry *container_ce, zend_class_entry *parent_ce) {
    php_cairo_path_data_t_get_handlers();
    PHP_CAIRO_INIT_CLASS_ENTRY((*container_ce), "cairo_path_data_t", php_cairo_path_data_t_methods);
...
php_cairo_path_data_t_create_header(php_cairo_path_data_t*intern, cairo_path_data_t *data){
    ...
    zend_std_write_property(rv->value.obj, member_type_str, &ztype, NULL);
    zend_std_write_property(rv->value.obj, member_length_str, &zlength, NULL);
...
php_cairo_path_data_t_create_point(php_cairo_path_data_t *intern, cairo_path_data_t *data){
    ...
    zend_std_write_property(rv->value.obj, member_x_str, &zx, NULL);
    zend_std_write_property(rv->value.obj, member_y_str, &zy, NULL);
