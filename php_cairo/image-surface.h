...
#define PHP_CAIRO_IMAGE_SURFACE_FE_10200() \
    PHP_CAIRO_FE(cairo_image_surface_get_data,        arginfo_cairo_image_surface_get_data) \
    PHP_CAIRO_FE(cairo_image_surface_get_format,      arginfo_cairo_image_surface_get_format) \
    PHP_CAIRO_FE(cairo_image_surface_get_stride,      arginfo_cairo_image_surface_get_stride)
#else
#define PHP_CAIRO_IMAGE_SURFACE_FE_10200()
#endif
...
#define PHP_CAIRO_IMAGE_SURFACE_FE_10000() \
    PHP_CAIRO_FE(cairo_image_surface_create,          arginfo_cairo_image_surface_create) \
    PHP_CAIRO_FE(cairo_image_surface_create_for_data, arginfo_cairo_image_surface_create_for_data) \
    PHP_CAIRO_FE(cairo_image_surface_get_width,       arginfo_cairo_image_surface_get_width) \
    PHP_CAIRO_FE(cairo_image_surface_get_height,      arginfo_cairo_image_surface_get_height)
#else
#define PHP_CAIRO_IMAGE_SURFACE_FE_10000()
#endif
