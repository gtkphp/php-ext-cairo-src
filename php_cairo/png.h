...
#define PHP_CAIRO_PNG_T_FE() \
    PHP_CAIRO_FE(cairo_image_surface_create_from_png,        arginfo_cairo_image_surface_create_from_png) \
    PHP_CAIRO_FE(cairo_image_surface_create_from_png_stream, arginfo_cairo_image_surface_create_from_png_stream) \
    PHP_CAIRO_FE(cairo_surface_write_to_png,                 arginfo_cairo_surface_write_to_png) \
    PHP_CAIRO_FE(cairo_surface_write_to_png_stream,          arginfo_cairo_surface_write_to_png_stream) \
