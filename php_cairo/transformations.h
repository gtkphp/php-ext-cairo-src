...
#define PHP_CAIRO_TRANSFORMATIONS_FE() \
    PHP_CAIRO_FE(cairo_translate,               arginfo_cairo_translate) \
    PHP_CAIRO_FE(cairo_scale,                   arginfo_cairo_scale) \
    PHP_CAIRO_FE(cairo_rotate,                  arginfo_cairo_rotate) \
    PHP_CAIRO_FE(cairo_transform,               arginfo_cairo_transform) \
    PHP_CAIRO_FE(cairo_set_matrix,              arginfo_cairo_set_matrix) \
    PHP_CAIRO_FE(cairo_get_matrix,              arginfo_cairo_get_matrix) \
    PHP_CAIRO_FE(cairo_identity_matrix,         arginfo_cairo_identity_matrix) \
    PHP_CAIRO_FE(cairo_user_to_device,          arginfo_cairo_user_to_device) \
    PHP_CAIRO_FE(cairo_user_to_device_distance, arginfo_cairo_user_to_device_distance) \
    PHP_CAIRO_FE(cairo_device_to_user,          arginfo_cairo_device_to_user) \
    PHP_CAIRO_FE(cairo_device_to_user_distance, arginfo_cairo_device_to_user_distance) \
