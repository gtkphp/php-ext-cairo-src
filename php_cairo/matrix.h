...
#define PHP_CAIRO_MATRIX_T_FE() \
    PHP_CAIRO_FE(cairo_matrix_init,               arginfo_cairo_matrix_init) \
    PHP_CAIRO_FE(cairo_matrix_init_identity,      arginfo_cairo_matrix_init_identity) \
    PHP_CAIRO_FE(cairo_matrix_init_translate,     arginfo_cairo_matrix_init_translate) \
    PHP_CAIRO_FE(cairo_matrix_init_scale,         arginfo_cairo_matrix_init_scale) \
    PHP_CAIRO_FE(cairo_matrix_init_rotate,        arginfo_cairo_matrix_init_rotate) \
    PHP_CAIRO_FE(cairo_matrix_translate,          arginfo_cairo_matrix_translate) \
    PHP_CAIRO_FE(cairo_matrix_scale,              arginfo_cairo_matrix_scale) \
    PHP_CAIRO_FE(cairo_matrix_rotate,             arginfo_cairo_matrix_rotate) \
    PHP_CAIRO_FE(cairo_matrix_invert,             arginfo_cairo_matrix_invert) \
    PHP_CAIRO_FE(cairo_matrix_multiply,           arginfo_cairo_matrix_multiply) \
    PHP_CAIRO_FE(cairo_matrix_transform_distance, arginfo_cairo_matrix_transform_distance) \
    PHP_CAIRO_FE(cairo_matrix_transform_point,    arginfo_cairo_matrix_transform_point) \
