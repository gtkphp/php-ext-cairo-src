...
#define PHP_CAIRO_GLYPH_T_FE() \
    PHP_CAIRO_FE(cairo_select_font_face,         arginfo_cairo_select_font_face) \
    PHP_CAIRO_FE(cairo_set_font_size,            arginfo_cairo_set_font_size) \
    PHP_CAIRO_FE(cairo_set_font_matrix,          arginfo_cairo_set_font_matrix) \
    PHP_CAIRO_FE(cairo_get_font_matrix,          arginfo_cairo_get_font_matrix) \
    PHP_CAIRO_FE(cairo_set_font_options,         arginfo_cairo_set_font_options) \
    PHP_CAIRO_FE(cairo_get_font_options,         arginfo_cairo_get_font_options) \
    PHP_CAIRO_FE(cairo_set_font_face,            arginfo_cairo_set_font_face) \
    PHP_CAIRO_FE(cairo_get_font_face,            arginfo_cairo_get_font_face) \
    PHP_CAIRO_FE(cairo_set_scaled_font,          arginfo_cairo_set_scaled_font) \
    PHP_CAIRO_FE(cairo_get_scaled_font,          arginfo_cairo_get_scaled_font) \
    PHP_CAIRO_FE(cairo_show_text,                arginfo_cairo_show_text) \
    PHP_CAIRO_FE(cairo_show_glyphs,              arginfo_cairo_show_glyphs) \
    PHP_CAIRO_FE(cairo_show_text_glyphs,         arginfo_cairo_show_text_glyphs) \
    PHP_CAIRO_FE(cairo_font_extents,             arginfo_cairo_font_extents) \
    PHP_CAIRO_FE(cairo_text_extents,             arginfo_cairo_text_extents) \
    PHP_CAIRO_FE(cairo_glyph_extents,            arginfo_cairo_glyph_extents) \
    PHP_CAIRO_FE(cairo_toy_font_face_create,     arginfo_cairo_toy_font_face_create) \
    PHP_CAIRO_FE(cairo_toy_font_face_get_family, arginfo_cairo_toy_font_face_get_family) \
    PHP_CAIRO_FE(cairo_toy_font_face_get_slant,  arginfo_cairo_toy_font_face_get_slant) \
    PHP_CAIRO_FE(cairo_toy_font_face_get_weight, arginfo_cairo_toy_font_face_get_weight) \
    PHP_CAIRO_FE(cairo_glyph_allocate,           arginfo_cairo_glyph_allocate) \
    PHP_CAIRO_FE(cairo_glyph_free,               arginfo_cairo_glyph_free) \
    PHP_CAIRO_FE(cairo_text_cluster_allocate,    arginfo_cairo_text_cluster_allocate) \
    PHP_CAIRO_FE(cairo_text_cluster_free,        arginfo_cairo_text_cluster_free) \
