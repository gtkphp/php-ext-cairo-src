...
#define PHP_CAIRO_T_FE() \
    PHP_CAIRO_FE(cairo_create,                   arginfo_cairo_create) \
    PHP_CAIRO_FE(cairo_reference,                arginfo_cairo_reference) \
    PHP_CAIRO_FE(cairo_destroy,                  arginfo_cairo_destroy) \
    PHP_CAIRO_FE(cairo_status,                   arginfo_cairo_status) \
    PHP_CAIRO_FE(cairo_save,                     arginfo_cairo_save) \
    PHP_CAIRO_FE(cairo_restore,                  arginfo_cairo_restore) \
    PHP_CAIRO_FE(cairo_get_target,               arginfo_cairo_get_target) \
    PHP_CAIRO_FE(cairo_push_group,               arginfo_cairo_push_group) \
    PHP_CAIRO_FE(cairo_push_group_with_content,  arginfo_cairo_push_group_with_content) \
    PHP_CAIRO_FE(cairo_pop_group,                arginfo_cairo_pop_group) \
    PHP_CAIRO_FE(cairo_pop_group_to_source,      arginfo_cairo_pop_group_to_source) \
    PHP_CAIRO_FE(cairo_get_group_target,         arginfo_cairo_get_group_target) \
    PHP_CAIRO_FE(cairo_set_source_rgb,           arginfo_cairo_set_source_rgb) \
    PHP_CAIRO_FE(cairo_set_source_rgba,          arginfo_cairo_set_source_rgba) \
    PHP_CAIRO_FE(cairo_set_source,               arginfo_cairo_set_source) \
    PHP_CAIRO_FE(cairo_set_source_surface,       arginfo_cairo_set_source_surface) \
    PHP_CAIRO_FE(cairo_get_source,               arginfo_cairo_get_source) \
    PHP_CAIRO_FE(cairo_set_antialias,            arginfo_cairo_set_antialias) \
    PHP_CAIRO_FE(cairo_get_antialias,            arginfo_cairo_get_antialias) \
    PHP_CAIRO_FE(cairo_set_dash,                 arginfo_cairo_set_dash) \
    PHP_CAIRO_FE(cairo_get_dash_count,           arginfo_cairo_get_dash_count) \
    PHP_CAIRO_FE(cairo_get_dash,                 arginfo_cairo_get_dash) \
    PHP_CAIRO_FE(cairo_set_fill_rule,            arginfo_cairo_set_fill_rule) \
    PHP_CAIRO_FE(cairo_get_fill_rule,            arginfo_cairo_get_fill_rule) \
    PHP_CAIRO_FE(cairo_set_line_cap,             arginfo_cairo_set_line_cap) \
    PHP_CAIRO_FE(cairo_get_line_cap,             arginfo_cairo_get_line_cap) \
    PHP_CAIRO_FE(cairo_set_line_join,            arginfo_cairo_set_line_join) \
    PHP_CAIRO_FE(cairo_get_line_join,            arginfo_cairo_get_line_join) \
    PHP_CAIRO_FE(cairo_set_line_width,           arginfo_cairo_set_line_width) \
    PHP_CAIRO_FE(cairo_get_line_width,           arginfo_cairo_get_line_width) \
    PHP_CAIRO_FE(cairo_set_miter_limit,          arginfo_cairo_set_miter_limit) \
    PHP_CAIRO_FE(cairo_get_miter_limit,          arginfo_cairo_get_miter_limit) \
    PHP_CAIRO_FE(cairo_set_operator,             arginfo_cairo_set_operator) \
    PHP_CAIRO_FE(cairo_get_operator,             arginfo_cairo_get_operator) \
    PHP_CAIRO_FE(cairo_set_tolerance,            arginfo_cairo_set_tolerance) \
    PHP_CAIRO_FE(cairo_get_tolerance,            arginfo_cairo_get_tolerance) \
    PHP_CAIRO_FE(cairo_clip,                     arginfo_cairo_clip) \
    PHP_CAIRO_FE(cairo_clip_preserve,            arginfo_cairo_clip_preserve) \
    PHP_CAIRO_FE(cairo_clip_extents,             arginfo_cairo_clip_extents) \
    PHP_CAIRO_FE(cairo_in_clip,                  arginfo_cairo_in_clip) \
    PHP_CAIRO_FE(cairo_reset_clip,               arginfo_cairo_reset_clip) \
    PHP_CAIRO_FE(cairo_rectangle_list_destroy,   arginfo_cairo_rectangle_list_destroy) \
    PHP_CAIRO_FE(cairo_copy_clip_rectangle_list, arginfo_cairo_copy_clip_rectangle_list) \
    PHP_CAIRO_FE(cairo_fill,                     arginfo_cairo_fill) \
    PHP_CAIRO_FE(cairo_fill_preserve,            arginfo_cairo_fill_preserve) \
    PHP_CAIRO_FE(cairo_fill_extents,             arginfo_cairo_fill_extents) \
    PHP_CAIRO_FE(cairo_in_fill,                  arginfo_cairo_in_fill) \
    PHP_CAIRO_FE(cairo_mask,                     arginfo_cairo_mask) \
    PHP_CAIRO_FE(cairo_mask_surface,             arginfo_cairo_mask_surface) \
    PHP_CAIRO_FE(cairo_paint,                    arginfo_cairo_paint) \
    PHP_CAIRO_FE(cairo_paint_with_alpha,         arginfo_cairo_paint_with_alpha) \
    PHP_CAIRO_FE(cairo_stroke,                   arginfo_cairo_stroke) \
    PHP_CAIRO_FE(cairo_stroke_preserve,          arginfo_cairo_stroke_preserve) \
    PHP_CAIRO_FE(cairo_stroke_extents,           arginfo_cairo_stroke_extents) \
    PHP_CAIRO_FE(cairo_in_stroke,                arginfo_cairo_in_stroke) \
    PHP_CAIRO_FE(cairo_copy_page,                arginfo_cairo_copy_page) \
    PHP_CAIRO_FE(cairo_show_page,                arginfo_cairo_show_page) \
    PHP_CAIRO_FE(cairo_get_reference_count,      arginfo_cairo_get_reference_count) \
    PHP_CAIRO_FE(cairo_set_user_data,            arginfo_cairo_set_user_data) \
    PHP_CAIRO_FE(cairo_get_user_data,            arginfo_cairo_get_user_data) \
